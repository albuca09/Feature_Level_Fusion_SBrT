...
1. Explorar a estrutura do dataset compactado em `.zip`;
2. Organizar e resumir os arquivos por classe, modalidade e amostra;
3. Converter anotações de vídeo para o formato YOLO;
4. Avaliar métodos de fusão de sensores para classificação binária e multiclasse.
...
1. Baixe ou mantenha disponível o arquivo:

```text
Drone-detection-dataset-master.zip
```

2. Ajuste os caminhos no notebook `FUSAO.ipynb`.
...
4. Verifique os resultados nos diretórios:
